...
{
	echo "<script type='text/javascript'>alert('WARNING: You are about to delete this student from your class, along with all attendance records!  Are you SURE you want to do this?')</script>";
?>
	<div class="datagrid">
	<table>
	<tr>
	...
	<form action="" method="post">
		<input type="submit" name="submit" value="Delete this student" />
    </form>
	</th>
	<th>
	<form action="class_table.php">
