...
{
	echo "<script type='text/javascript'>alert('WARNING: You are about to permanently delete this client from the database, along with all associated records!  Are you SURE you want to do this?')</script>";
?>
	<div class="datagrid">
	<table>
	<tr>
	...
	<form action="" method="post">
		<input type="submit" name="submit" value="Delete this Client Forever" />
    </form>
	</th>
	<th>
	<form action="client_table.php">
