...
if(isset($_POST['add'])){
	...
	$sql2 = "CALL new_trans ".
       "('$amount', '$t_date', '$description', '$c_name', '$c_first_name', '$c_last_name', '$p_name', '$category_name', '$account_name', '$classID', null) ";
...
<?php
	$i=0;
	while ($i < $num7) {
		$f7=mysql_result($result7,$i,"class_name");
?>
...
<td>
<a href="edit_transaction.php?search=<?php echo $f11;?>">
  <?php echo 'Edit';?>
</a>
</td>
</tr>
