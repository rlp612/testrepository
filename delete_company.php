...
<?php
	...
	echo "<script type='text/javascript'>alert('WARNING: You are about to permanently delete this company from the database, along with all associated records!  Are you SURE you want to do this?')</script>";
