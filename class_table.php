...
<?php
	...
	$query="select c.start_date, c.end_date, c.day_of_week, c.prod_name, d.company_name
			from (select a.*, b.prod_name from class a inner join products b on a.productID=b.productID) c
